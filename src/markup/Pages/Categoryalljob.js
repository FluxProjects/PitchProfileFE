                ...
                <div className="category-jobs-info">
                  <div className="nav">
                    <ul>
                      ...
                      <li>
                        <Link to={"/category-location-jobs"}>
                          Jobs by Location
                        </Link>
                      </li>
                      <li>
                    ...
                    <div className="job-bx bg-white">
                      ...
                      <div className="row">
                        {cityBox.map((item, index) => (
                          <div
                            className="col-lg-3 col-sm-6 col-md-6 m-b30"
                            key={index}
                          >
                            <Link to={"#"}>
                              <div
                      ...
                      <div className="row">
                        <div className="col-lg-6 col-sm-6">
                          <ul className="category-list">
                            <li>
                              <Link to={"#"}>Android Jobs</Link>
                            </li>
                            <li>
                              <Link to={"#"}>WordPress Jobs</Link>
                            </li>
                            <li>
                              <Link to={"#"}>eCommerce Jobs</Link>
                            </li>
                            <li>
                              <Link to={"#"}>Design Jobs</Link>
                            </li>
                            <li>
                              <Link to={"#"}>Mobile Jobs</Link>
                            </li>
                            <li>
                              <Link to={"#"}>MySQL Jobs</Link>
                            </li>
                            <li>
                              <Link to={"#"}>SEO Jobs</Link>
                            </li>
                          </ul>
                        </div>
                        <div className="col-lg-6 col-sm-6">
                          <ul className="category-list">
                            ...
                            <li>
                              <Link to={"#"}>Programming Jobs</Link>
                            </li>
                            <li>
                              <Link to={"#"}>JavaScript Jobs</Link>
                            </li>
                            <li>
                              <Link to={"#"}>Developer Jobs</Link>
                            </li>
                            <li>
                              <Link to={"#"}>Software Jobs</Link>
                            </li>
                          </ul>
                        </div>
                      </div>
                    ...
                    <div className="job-bx bg-white">
                      ...
                      <div className="row">
                        ...
                        <div className="col-lg-6 col-sm-6">
                          <ul className="category-list">
                            <li>
                              <Link to={"#"}>Website Design Jobs</Link>
                            </li>
                            <li>
                              <Link to={"#"}>Web Development Jobs</Link>
                            </li>
                            <li>
                              <Link to={"#"}>Web Design Jobs</Link>
                            </li>
                            <li>
                              <Link to={"#"}>Programming Jobs</Link>
                            </li>
